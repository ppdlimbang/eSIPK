(async () => {
  ...
  assert(getSpecialSchoolOptions('YRA5101 SEKOLAH MENENGAH KEBANGSAAN AGAMA LIMBANG').includes('Blok D'), 'Full imported SMK Agama Limbang name gets Blok D special quarters');
